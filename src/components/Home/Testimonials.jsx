...
function TestimonialCard({ name, message, avatar }) {
  return (
    <div className="bg-white shadow-2xl rounded-lg p-8 text-center mx-auto w-full max-w-md my-4 min-h-[350px]"> {/* Card width and height adjusted */}
      <img
        src={avatar}
        alt={`${name}'s avatar`}
...
function Testimonials() {
  const testimonialsData = [
    {
      name: "John Doe",
      message: "Booking was a breeze, and the journey was comfortable from start to finish. Truly a service I can trust!",
      avatar: "path/to/avatar1.jpg",
    },
    {
      name: "Jane Smith",
      message: "Reliable and easy to use. I recommend this service to all my friends and family!",
      avatar: "path/to/avatar2.jpg",
    },
    {
      name: "Michael Brown",
      message: "Excellent customer service and timely buses. Made my travel stress-free and enjoyable!",
    ...
    <div className="font-poppins mt-20">
      ...
      <div className="text-center">
        ...
        <p className="mt-4 text-base md:text-lg text-grayText px-4 md:px-0">
          Discover why travelers rely on us for their journeys. Here’s what our happy passengers have to say!
        </p>
      </div>

      {/* Testimonial Slider Section with a different background */}
      <div className="bg-blue-100 p-8 md:p-16 rounded-lg bg-white2 shadow-lg mt-8"> {/* Responsive padding */}
        <Slider {...settings}>
