...
import {
  ...
  FaShieldAlt, FaRegCreditCard, FaWifi, FaSnowflake, FaChargingStation,
  FaToilet, FaAward, FaFilter
} from "react-icons/fa";
...
const SearchPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-Darkgreen overflow-hidden mt-24 sm:mt-28 md:mt-32 lg:mt-36">
        <Container maxWidth="xl" className="relative py-12 sm:py-16 md:py-20 lg:py-24 px-4">
          <div className="text-center text-white space-y-4 sm:space-y-6 mb-8 sm:mb-12 md:mb-16">
            ...
            >
              Travel safely and comfortably across India with our premium bus services
            </motion.p>
          </div>
      ...
      <Container maxWidth="xl" className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6">
        {loading && (
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-lg p-6 sticky top-24">
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-2">
                    {[
                      { icon: <FaWifi className="text-gray-500" />, label: "WiFi", value: "wifi" },
                      { icon: <FaSnowflake className="text-gray-500" />, label: "AC", value: "ac" },
                      { icon: <FaChargingStation className="text-gray-500" />, label: "Charging Point", value: "charging" },
                      { icon: <BiDrink className="text-gray-500" />, label: "Water Bottle", value: "water" },
                      { icon: <FaToilet className="text-gray-500" />, label: "Washroom", value: "washroom" }
                    ].map((amenity) => (
                      <label key={amenity.value} className="flex items-center">
                        <input
                          type="checkbox"
                          checked={filters.amenities.includes(amenity.value)}
                          onChange={() => handleFilterChange('amenity', amenity.value)}
                          className="form-checkbox h-4 w-4 text-Darkgreen rounded border-gray-300 focus:ring-Darkgreen"
                        />
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  >
                    ...
                    <option value="departure_early">Departure: Earliest First</option>
                  </select>
                </div>
              </div>
      ...
      <div className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white mt-8 sm:mt-12 md:mt-16">
        <Container maxWidth="xl">
          ...
          >
            {[
              { icon: <FaUserFriends />, count: "1M+", text: "Happy Travelers", subtext: "and counting" },
              { icon: <FaBus />, count: "500+", text: "Bus Partners", subtext: "trusted operators" },
              { icon: <FaRoute />, count: "2000+", text: "Routes", subtext: "across India" },
              { icon: <FaPhoneAlt />, count: "24/7", text: "Customer Support", subtext: "always available" }
            ].map((stat, index) => (
              <motion.div
                key={index}
                whileHover={{ y: -5 }}
              ...
              >
                ...
                <div className="text-4xl font-bold text-Darkgreen mb-2">{stat.count}</div>
                <div className="text-gray-900 font-medium mb-1">{stat.text}</div>
      ...
      <div className="mb-8 sm:mb-12 bg-white rounded-lg shadow-lg p-4 sm:p-6 mx-4 sm:mx-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          <div className="flex items-center space-x-4 bg-gray-50 p-4 rounded-lg">
            ...
            <div>
              <h3 className="font-semibold">Sanitized Buses</h3>
              <p className="text-sm text-gray-600 mt-1">Regular sanitization of all buses</p>
            </div>
          </div>
          <div className="flex items-center space-x-4 bg-gray-50 p-4 rounded-lg">
            <div className="text-3xl text-Darkgreen">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Maintained seating arrangement</p>
            </div>
          </div>
          <div className="flex items-center space-x-4 bg-gray-50 p-4 rounded-lg">
            <div className="text-3xl text-Darkgreen">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Online tickets and payments</p>
            </div>
          </div>
        </div>
      </div>
