...
function Footer() {
  return (
    <footer className="bg-blue roboto-slab-custom  text-grayWhite border-none p-4 border-y">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="flex flex-row">
            <div className="mr-40">
              <h2 className="mb-6 text-sm font-thin text-white ">
                About BookMyBus
              </h2>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
            <Link to="#" className="text-white hover:text-teal">
              <svg
                className="w-4 h-4"
                aria-hidden="true"
            ...
            <a
              href="https://discord.gg/jpRePQpC"
              target="_blank"
            ...
            >
              <svg
                className="w-4 h-4 hover:text-yellow-25"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 20 20"
